...
| `dumps` | function | `(value: 'Any', *, indent: 'int \| None' = None, max_line_length: 'int' = 88, positional_first_id_or_name: 'bool' = False, positional_first_field_names: 'Iterable[str] \| None' = None, positional_single_field: 'bool' = True, preserve_spans: 'bool' = True) -> 'str'` | `mu.printer` | Serialize a value to Mu source text. |
| `dumps_concise` | function | `(value: 'Any', *, max_line_length: 'int' = 88, positional_first_id_or_name: 'bool' = False, positional_first_field_names: 'Iterable[str] \| None' = None, positional_single_field: 'bool' = True, preserve_spans: 'bool' = True) -> 'str'` | `mu.printer` | Serialize a value using concise formatting. |
| `dumps_pretty` | function | `(value: 'Any', *, indent: 'int' = 2, max_line_length: 'int' = 88, positional_first_id_or_name: 'bool' = False, positional_first_field_names: 'Iterable[str] \| None' = None, positional_single_field: 'bool' = True, preserve_spans: 'bool' = True) -> 'str'` | `mu.printer` | Serialize a value using pretty multiline formatting. |
